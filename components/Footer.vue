      ...
      <div class="flex justify-start">
        <div class="flex gap-1 items-center">
          <a href="https://github.com/Colty1999" target="_blank" rel="noopener noreferrer"
            ...
            <span class="z-10 relative transition duration-300 ease-in-out group-hover:text-secondary-text">
              <font-awesome-icon icon="fa-brands fa-github" />
            </span>
            <span
              class="absolute top-0 left-0 w-full h-full bg-tertiary z-0 transform -translate-x-full transition duration-300 ease-in-out group-hover:translate-x-0"></span>
          </a>
          <a href="https://www.linkedin.com/in/mgietka/" target="_blank" rel="noopener noreferrer"
            class="relative w-8 h-8 inline-flex items-center justify-center bg-transparent border-0.1 border-tertiary rounded-full text-tertiary no-underline overflow-hidden group">
            <span class="z-10 relative transition duration-300 ease-in-out group-hover:text-secondary-text">
